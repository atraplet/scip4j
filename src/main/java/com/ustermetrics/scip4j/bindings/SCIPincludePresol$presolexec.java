 ...
 * }
 */
public class SCIPincludePresol$presolexec {

    SCIPincludePresol$presolexec() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPincludePresol$presolexec.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPincludePresol$presolexec.Function fi, Arena arena) {
