...
/**
 * {@snippet lang=c :
 * SCIP_RETCODE (*inteval)(SCIP *, SCIP_NLHDLR *, SCIP_EXPR *, SCIP_NLHDLREXPRDATA *, SCIP_INTERVAL *, SCIP_INTERVAL (*)(SCIP *, SCIP_VAR *, void *), void *)
 * }
 */
public class SCIPnlhdlrSetProp$inteval {

    SCIPnlhdlrSetProp$inteval() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPnlhdlrSetProp$inteval.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPnlhdlrSetProp$inteval.Function fi, Arena arena) {
