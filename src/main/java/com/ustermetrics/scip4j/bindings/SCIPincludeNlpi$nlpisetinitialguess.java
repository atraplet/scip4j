...
/**
 * {@snippet lang=c :
 * SCIP_RETCODE (*nlpisetinitialguess)(SCIP *, SCIP_NLPI *, SCIP_NLPIPROBLEM *, double *, double *, double *, double *)
 * }
 */
public class SCIPincludeNlpi$nlpisetinitialguess {

    SCIPincludeNlpi$nlpisetinitialguess() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPincludeNlpi$nlpisetinitialguess.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPincludeNlpi$nlpisetinitialguess.Function fi, Arena arena) {
