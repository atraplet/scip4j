 ...
 * }
 */
public class SCIPcreateVar$varcopy {

    SCIPcreateVar$varcopy() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPcreateVar$varcopy.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPcreateVar$varcopy.Function fi, Arena arena) {
