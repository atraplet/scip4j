 ...
 * }
 */
public class SCIPsetPropPresol$proppresol {

    SCIPsetPropPresol$proppresol() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPsetPropPresol$proppresol.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPsetPropPresol$proppresol.Function fi, Arena arena) {
