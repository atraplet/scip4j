 ...
 * }
 */
public class SCIPcreateExprValue$ownercreate {

    SCIPcreateExprValue$ownercreate() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPcreateExprValue$ownercreate.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPcreateExprValue$ownercreate.Function fi, Arena arena) {
