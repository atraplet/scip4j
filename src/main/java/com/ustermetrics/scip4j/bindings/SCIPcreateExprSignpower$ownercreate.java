 ...
 * }
 */
public class SCIPcreateExprSignpower$ownercreate {

    SCIPcreateExprSignpower$ownercreate() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPcreateExprSignpower$ownercreate.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPcreateExprSignpower$ownercreate.Function fi, Arena arena) {
