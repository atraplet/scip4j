 ...
 * }
 */
public class SCIPcreateExprProduct$ownercreate {

    SCIPcreateExprProduct$ownercreate() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPcreateExprProduct$ownercreate.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPcreateExprProduct$ownercreate.Function fi, Arena arena) {
