 ...
 * }
 */
public class SCIPsetBendersPresubsolve$benderspresubsolve {

    SCIPsetBendersPresubsolve$benderspresubsolve() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPsetBendersPresubsolve$benderspresubsolve.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPsetBendersPresubsolve$benderspresubsolve.Function fi, Arena arena) {
