 ...
 * }
 */
public class SCIPvarSetCopyData$varcopy {

    SCIPvarSetCopyData$varcopy() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPvarSetCopyData$varcopy.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPvarSetCopyData$varcopy.Function fi, Arena arena) {
