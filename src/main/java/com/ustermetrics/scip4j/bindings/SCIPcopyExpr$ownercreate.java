 ...
 * }
 */
public class SCIPcopyExpr$ownercreate {

    SCIPcopyExpr$ownercreate() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPcopyExpr$ownercreate.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPcopyExpr$ownercreate.Function fi, Arena arena) {
