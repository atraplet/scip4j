 ...
 * }
 */
public class SCIPincludeSepaBasic$sepaexecsol {

    SCIPincludeSepaBasic$sepaexecsol() {
    ...
    private static final MethodHandle UP$MH = scip_h.upcallHandle(SCIPincludeSepaBasic$sepaexecsol.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SCIPincludeSepaBasic$sepaexecsol.Function fi, Arena arena) {
